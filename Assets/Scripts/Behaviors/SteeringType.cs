...
public partial class Steering {
    ...
    private float weightWander;
    private float weightObstacleAvoidance;
    private float weightWallAvoidance;
    private float weightSeek;
    private float weightFlee;
    private float weightArrive;
    private float weightPursuit;
    private float weightOffsetPursuit;
    private float weightInterpose;
    private float weightHide;
    private float weightEvade;
    private float weightFollowPath;
    private float wallDetectionFeelerLength;
    private float viewDistance;
    //private Path path;
    private float waypointSeekDistSq;
    Vector3     offset;
    //检测盒（AABB）长度
